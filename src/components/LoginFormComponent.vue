<template>
    <div class=" pt-5">
        <form class="bg-white p-4 rounded">
            <h3 class="text-start">Logueate</h3>
            <div class="mb-3">
            ...
            <div class="d-grid gap-2 pb-5">
                <button class="btn btn-primary text-white rounded-pill" type="button" id="buttonSend">Enviar</button>
        ...
        sendLogin() {
            ...
            fetch("https://rafalopez.ar/v1/login", requestOptions)
                .then(response => {
                    ...
                    console.log('Cookies de la respuesta:', response.headers.get('Set-Cookie'));
